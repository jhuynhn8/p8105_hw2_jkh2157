...
Since multiple neighborhoods were collapsed into a single string per ZIP to keep the dataset tidy, counting neighborhoods directly from the final dataset would understate the true number. To accurately report the number of unique neighborhoods represented, I used the original ZIP code file before collapsing. I still pulled zips from the final becasue those stayed consistent. There **149 unique zips and 42 unique neighbhorhoods.** 
...
Step 6:  Compare rental prices in January 2021 to prices in January 2020. Make a table that shows the 10 ZIP codes (along with the borough and neighborhood) with largest drop in price from January 2020 to 2021. 
